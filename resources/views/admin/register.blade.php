      ...
      <form action="{{ route('admin.register.store') }}" method="post" no-reset="true">
        ...
        <div class="row"> 
          <div class="col-12 form-group">
            <button type="submit" class="btn btn-block" style="background-color:#31ba32;color:#fff">Register</button>
          </div>
          <div class="col-12 form-group">
            <a href="{{ route('admin.login') }}" class="text-center" style="color:#31ba32">I already have a membership</a>
          </div>
        </div>
      </form>  
    </div>
