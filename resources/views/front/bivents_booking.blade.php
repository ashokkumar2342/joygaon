                ...
                <form action="{{ route('front.booking.store') }}" method="post">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <input  name="contact_mobile_no" class="form-control" maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required value="" readonly placeholder="Enter Mobile No."> 
